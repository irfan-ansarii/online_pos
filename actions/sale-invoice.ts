...
async function drawFooter(doc: jsPDF, options: Options) {
  ...
  try {
    /** qr code */
    const qr = fs.readFileSync("public/assets/qr.png");

    doc.addImage(qr, left, 180, 15, 15);
  } catch (error) {}
  ...
  drawText(
    doc,
    "Scan the QR code to connect with us on Instagram!",
    left + 17,
    192,
    {
      style: "italic",
  ...
  const footerText = [
    ...
    { text: "www.goldysnestt.com", url: "https://www.goldysnestt.com" },
    {
